...
def main():
    ...
    parser.add_argument("-t", "--text_files", nargs="+", default=None, help="Input text files")
    ...
    if args.text_files is None and args.input_dir is None:
        raise ValueError("Input must be either path to text file(s) or directory with text files")
